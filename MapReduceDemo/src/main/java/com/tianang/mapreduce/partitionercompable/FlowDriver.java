package com.tianang.mapreduce.partitionercompable;
...
public class FlowDriver {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // Setting up the custom partitioner.
        job.setPartitionerClass(ProvincePartitioner.class);

        // Setting up the number of ReduceTask.
        job.setNumReduceTasks(5); // This number should be as same the number of partitions.
